...
//isAddressExist('120.110.114.21');
//removeIP('limit3', '120.110.114.0.8');
//removeIP('limit3', '120.110.114.21');
//setIP('limit3', '120.110.114.0.8');
//setAddress('120.110.114.0.8','120.110.114.0/8');
...
function setAddress(name, ip) {
    var options = {
        hostname: '120.110.114.35',
        port: 443,
        path: '/api/?type=config&action=set&' +
            "xpath=/config/devices/entry/vsys/entry/address/entry[@name='" + name + "']&" +
...
//
function isAddressExist(ip, exist, notexist) {
    var options = {
        hostname: '120.110.114.35',
        port: 443,
        path: "/api/?type=config&action=show&xpath=/config/devices/entry/vsys/entry/address/entry[@name='" + ip + "']&key=LUFRPT1CS2I1a28wVk0vb2d5a1pSZDlJSTloTlNYVUU9OWVJZE5MT0lvQ3MxOFVzaFlEMUNnQT09",
        method: 'get'
    };
...
function removeIP(entryName, ip) {
    var options = {
        hostname: '120.110.114.35',
        port: 443,
        path: "/api/?type=config&action=delete&xpath=/config/devices/entry/vsys/entry/address-group/entry[@name='" + entryName + "']/member[text()='" + ip + "']&key=LUFRPT1CS2I1a28wVk0vb2d5a1pSZDlJSTloTlNYVUU9OWVJZE5MT0lvQ3MxOFVzaFlEMUNnQT09",
        method: 'get'
    };
...
function commit() {
    var options = {
        hostname: '120.110.114.35',
        port: 443,
        path: "/api/?type=commit&cmd=<commit></commit>&key=LUFRPT1CS2I1a28wVk0vb2d5a1pSZDlJSTloTlNYVUU9OWVJZE5MT0lvQ3MxOFVzaFlEMUNnQT09",
        method: 'get'
    };
...
function setIP(entryName, ip) {
    var options = {
        ...
        port: 443,
        path: '/api/?type=config&action=set&' +
            "xpath=/config/devices/entry/vsys/entry/address-group/entry[@name='" + entryName + "']&element=<member>" + ip + "</member>&" +
            'key=LUFRPT1CS2I1a28wVk0vb2d5a1pSZDlJSTloTlNYVUU9OWVJZE5MT0lvQ3MxOFVzaFlEMUNnQT09',
        method: 'get'
    };
    console.log(options);
